...
|                |                    |                    |
|                | -   Introduction   | Installations of   |
|                |     to *ggplot2*   | packages.          |
|                |                    |                    |
|                | -   Introduction   | Tidyverse actions  |
|                |     to *Shiny*     | (filter,           |
|                |     dashboard      |                    |
+----------------+--------------------+--------------------+
| 3              | -   Introduction   | Variable coercion  |
|                |     to variables   | (numerical to      |
|                |                    | logical for cate   |
|                | -   Types of       | g                  |
|                |     variables      | orisation/grouping |
|                |                    | in plots,          |
|                | -   Working with   | character to date  |
|                |     variables      | for agecalc()) for |
|                |                    | analysis           |
|                | -   Data           |                    |
|                |     structures     | Vector creation    |
|                |                    | and access within  |
|                | -   Coercion       | ggplot2            |
|                |                    |                    |
...
|                |                    | function           |
+----------------+--------------------+--------------------+
| 4              | Manipulating data  | Piping and         |
|                |                    | mutation to create |
|                | -   Creating       | new variables from |
|                |     lists, tibbles | the data           |
|                |     and dataframes |                    |
|                |                    | casewhen(),        |
|                | -   Pipes          | if-else logic in   |
|                |                    | manipulating data  |
|                | -   Reading from   | (mutate)           |
|                |     and writing to |                    |
