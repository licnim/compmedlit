...
\textbf{Solution:} \emph{CSV stands for `comma-separated values'. It is
a popular format because the data is in a minimal and basic form that
makes it easy to work with when analysed in different softwares in
different ways.} \textbf{Question 1.2:} load the \texttt{tidyverse}
...
\FunctionTok{read\_csv}\NormalTok{(}\StringTok{"/Users/nic/Library/CloudStorage/OneDrive{-}NationalUniversityofSingapore/NM2207/Week 2/playlist\_data.csv"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\NormalTok{playlist\_data }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"/Users/nic/Library/CloudStorage/OneDrive{-}NationalUniversityofSingapore/NM2207/Week 2/playlist\_data.csv"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{"/Users/nic/Library/CloudStorage/OneDrive{-}NationalUniversityofSingapore/NM2207/Week 2/Screenshot 2023{-}08{-}21 at 6.12.25 PM.png"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}
\includegraphics[width=800px,height=400px]{Screenshot 2023-08-21 at 6.12.25 PM} \caption{Information}\label{fig:unnamed-chunk-5}
\end{figure}

\textbf{Question 1.6:} What does the \texttt{skip} argument in the
read\_csv() function do?

\textbf{Solution:} \emph{It instructs the program to to skip or ignore a
specified number of lines before beginning to read the data.}
...
\NormalTok{playlist\_data }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{pull}\NormalTok{(Location)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{playlist\_data }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{pull}\NormalTok{(Age)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{playlist\_data, }\AttributeTok{mapping=}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Age,}\AttributeTok{y=}\NormalTok{Rating)) }\SpecialCharTok{+} \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{labs}\NormalTok{(}\AttributeTok{x=}\StringTok{"Age (years)"}\NormalTok{, }\AttributeTok{y=}\StringTok{"Ratings (out of 5)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{playlist\_data, }\AttributeTok{mapping=}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Age,}\AttributeTok{y=}\NormalTok{Rating)) }\SpecialCharTok{+} \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{shape=}\DecValTok{8}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{labs}\NormalTok{(}\AttributeTok{x=}\StringTok{"Age (years)"}\NormalTok{, }\AttributeTok{y=}\StringTok{"Ratings (out of 5)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{playlist\_data, }\AttributeTok{mapping=}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Age,}\AttributeTok{y=}\NormalTok{Rating)) }\SpecialCharTok{+} \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{shape=}\DecValTok{8}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{labs}\NormalTok{(}\AttributeTok{title=}\StringTok{"Relationship between DJs\textquotesingle{} ages and their ratings"}\NormalTok{, }\AttributeTok{x=}\StringTok{"Age (years)"}\NormalTok{, }\AttributeTok{y=}\StringTok{"Ratings (out of 5)"}\NormalTok{, }\AttributeTok{caption =} \StringTok{"There is a weakly positive relationship between DJs\textquotesingle{} ages and their ratings."}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
